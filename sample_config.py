...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "SuperBot_APIScrapper")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "SuperBot_APIScrapper")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/<xyz>")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/<xyz>"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @Disheartened_007")
